    ...
    <div className="flex flex-col sm:flex-row items-center justify-between mt-8 md:mt-12 gap-4">
      {prevTopicId ? (
        <Link
          ...
          className="w-full sm:flex-1 flex items-center justify-center gap-2 px-6 py-4 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl font-bold text-sm hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-all active:scale-95 shadow-sm"
        >
      ...
      {nextTopicId && (
        <div className="relative w-full sm:flex-1 group">
          <Link
            ...
            className={`
              w-full flex items-center justify-center gap-2 px-6 py-4 border rounded-2xl font-bold text-sm transition-all shadow-sm
              ${isCompleted 
          ...
          {!isCompleted && (
            <div className="absolute -top-12 left-1/2 -translate-x-1/2 px-3 py-1 bg-black dark:bg-white text-white dark:text-black text-[10px] rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none z-10">
