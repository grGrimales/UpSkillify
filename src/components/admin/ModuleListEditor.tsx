            ...
            {editingId === mod.id ? (
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <Link 
                    href={`/admin/courses/${courseId}/modules/${mod.id}?mode=exams`}
                    className="flex-1 md:flex-none px-4 py-2.5 bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-white rounded-xl text-xs font-black uppercase tracking-widest hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-all text-center flex items-center justify-center gap-2"
                  >
