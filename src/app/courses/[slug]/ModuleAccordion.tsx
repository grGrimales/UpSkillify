  ...
  return (
    <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden">
      <button
        ...
        className={`w-full p-6 flex flex-col md:flex-row justify-between md:items-center gap-4 text-left transition-colors hover:bg-zinc-50 dark:hover:bg-zinc-800/50 ${isOpen ? "border-b border-zinc-100 dark:border-zinc-800" : ""}`}
      >
